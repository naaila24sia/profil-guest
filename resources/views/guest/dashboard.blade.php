...
@section('content')
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="donation-item">
                        <img src="{{ asset('assets-guest/img/donation-1.jpg') }}" class="img-fluid w-100"
                            alt="Image">
                ...
                <div class="col-lg-4">
                    <div class="donation-item">
                        <img src="{{ asset('assets-guest/img/donation-3.jpg') }}" class="img-fluid w-100"
                            alt="Image">
                        <div class="donation-content d-flex flex-column">
    ...
    <div class="container-fluid counter py-5"
        style="background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, 0.4)), url(assets-guest/img/volunteers-bg.jpg) center center; background-size: cover;">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5" style="max-width: 800px;">
                    ...
                    <div class="blog-item">
                        <div class="blog-img">
                            ...
                            <div class="search-icon">
                                <a href="{{ asset('assets-guest/img/blog-1.jpg') }}" data-lightbox="Blog-1"
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="blog-item">
                        <div class="blog-img">
                            ...
                            <div class="search-icon">
                                <a href="{{ asset('assets-guest/img/blog-2.jpg') }}" data-lightbox="Blog-2"
                                    class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                            </div>
                        </div>
                        <div class="text-dark border p-4 ">
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="blog-item">
                        <div class="blog-img">
                            ...
                            <div class="search-icon">
                                <a href="{{ asset('assets-guest/img/blog-3.jpg') }}" data-lightbox="Blog-3"
                                    class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                            </div>
                        </div>
                        <div class="text-dark border p-4 ">
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="blog-item">
                        <div class="blog-img">
                            ...
                            <div class="search-icon">
                                <a href="{{ asset('assets-guest/img/blog-4.jpg') }}" data-lightbox="Blog-4"
                                    class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                            </div>
                        </div>
                        <div class="text-dark border p-4 ">
        ...
        <div class="row g-0">
            <div class="col-lg-4">
                <div class="gallery-item">
                    ...
                    <div class="search-icon">
                        <a href="{{ asset('assets-guest/img/gallery-2.jpg') }}" data-lightbox="gallery-2"
                            class="my-auto"><i
                ...
                <div class="gallery-item">
                    ...
                    <div class="search-icon">
                        <a href="{{ asset('assets-guest/img/gallery-3.jpg') }}" data-lightbox="gallery-3"
                            class="my-auto"><i
                                class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                    </div>
                    <div class="gallery-content">
            ...
            <div class="col-lg-4">
                <div class="gallery-item">
                    ...
                    <div class="search-icon">
                        <a href="{{ asset('assets-guest/img/gallery-1.jpg') }}" data-lightbox="gallery-1"
                            class="my-auto"><i
                                class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                    </div>
                    <div class="gallery-content">
            ...
            <div class="col-lg-4">
                <div class="gallery-item">
                    ...
                    <div class="search-icon">
                        <a href="{{ asset('assets-guest/img/gallery-4.jpg') }}" data-lightbox="gallery-4"
                            class="my-auto"><i
                                class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                    </div>
                    <div class="gallery-content">
                ...
                <div class="gallery-item">
                    ...
                    <div class="search-icon">
                        <a href="{{ asset('assets-guest/img/gallery-5.jpg') }}" data-lightbox="gallery-5"
                            class="my-auto"><i
                                class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                    </div>
                    <div class="gallery-content">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="volunteer-img">
                                <img src="{{ asset('assets-guest/img/volunteers-1.jpg') }}" class="img-fluid w-100"
                                    alt="Image">
                        ...
                        <div class="col-lg-6">
                            <div class="volunteer-img">
                                <img src="{{ asset('assets-guest/img/volunteers-3.jpg') }}" class="img-fluid w-100"
                                    alt="Image">
                                <div class="volunteer-title">
                                    <h5 class="mb-2 text-white">Michel Brown</h5>
                                    <p class="mb-0 text-white">Communicator</p>
                        ...
                        <div class="col-lg-6">
                            <div class="volunteer-img">
                                <img src="{{ asset('assets-guest/img/volunteers-2.jpg') }}" class="img-fluid w-100"
                                    alt="Image">
                                <div class="volunteer-title">
                                    <h5 class="mb-2 text-white">Michel Brown</h5>
                                    <p class="mb-0 text-white">Communicator</p>
                        ...
                        <div class="col-lg-6">
                            <div class="volunteer-img">
                                <img src="{{ asset('assets-guest/img/volunteers-4.jpg') }}" class="img-fluid w-100"
                                    alt="Image">
                                <div class="volunteer-title">
                                    <h5 class="mb-2 text-white">Michel Brown</h5>
                                    <p class="mb-0 text-white">Communicator</p>
