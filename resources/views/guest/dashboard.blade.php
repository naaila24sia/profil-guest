...
<html lang="en">
    ...
    <body>
       ...
       <!-- Carousel Start -->
        ...
        <div class="container-fluid about  py-5">
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-xl-5">
                        <div class="h-100">
                            <img src="{{asset('assets-guest/img/about-1.jpg')}}" class="img-fluid w-100 h-100" alt="Image">
                        </div>
                    </div>
                    <div class="col-xl-7">
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="service-item">
                            <img src="{{asset('assets-guest/img/service-1.jpg')}}" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="service-item">
                            <img src="{{asset('assets-guest/img/service-2.jpg')}}" class="img-fluid w-100" alt="Image">
                            <div class="service-link">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="service-item">
                            <img src="{{asset('assets-guest/img/service-3.jpg')}}" class="img-fluid w-100" alt="Image">
                            <div class="service-link">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="service-item">
                            <img src="{{asset('assets-guest/img/service-4.jpg')}}" class="img-fluid w-100" alt="Image">
                            <div class="service-link">
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="{{asset('assets-guest/img/donation-1.jpg')}}" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="{{asset('assets-guest/img/donation-3.jpg')}}" class="img-fluid w-100" alt="Image">
                            <div class="donation-content d-flex flex-column">
        ...
        <!-- Counter Start -->
        <div class="container-fluid counter py-5" style="background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, 0.4)), url(assets-guest/img/volunteers-bg.jpg) center center; background-size: cover;">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5" style="max-width: 800px;">
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('assets-guest/img/causes-4.jpg')}}" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('assets-guest/img/causes-2.jpg')}}" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('assets-guest/img/causes-3.jpg')}}" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('assets-guest/img/causes-1.jpg')}}" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                ...
                                <div class="search-icon">
                                    <a href="{{asset('assets-guest/img/blog-1.jpg')}}" data-lightbox="Blog-1" class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                ...
                                <div class="search-icon">
                                    <a href="{{asset('assets-guest/img/blog-2.jpg')}}" data-lightbox="Blog-2" class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                                </div>
                            </div>
                            <div class="text-dark border p-4 ">
                                <h4 class="mb-4">Save The Topic Forests</h4>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                ...
                                <div class="search-icon">
                                    <a href="{{asset('assets-guest/img/blog-3.jpg')}}" data-lightbox="Blog-3" class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                                </div>
                            </div>
                            <div class="text-dark border p-4 ">
                                <h4 class="mb-4">Save The Topic Forests</h4>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{asset('assets-guest/img/blog-4.jpg')}}" class="img-fluid w-100" alt="">
                                <div class="blog-info">
                                    <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                    <div class="d-flex">
                                        <span class="me-3"> 3 <i class="fa fa-heart"></i></span>
                                ...
                                <div class="search-icon">
                                    <a href="{{asset('assets-guest/img/blog-4.jpg')}}" data-lightbox="Blog-4" class="my-auto"><i class="fas fa-search-plus btn-primary text-white p-3"></i></a>
                                </div>
                            </div>
                            <div class="text-dark border p-4 ">
                                <h4 class="mb-4">Save The Topic Forests</h4>
            ...
            <div class="row g-0">
                <div class="col-lg-4">
                    <div class="gallery-item">
                        ...
                        <div class="search-icon">
                            <a href="{{asset('assets-guest/img/gallery-2.jpg')}}" data-lightbox="gallery-2" class="my-auto"><i class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                        </div>
                    ...
                    <div class="gallery-item">
                        ...
                        <div class="search-icon">
                            <a href="{{asset('assets-guest/img/gallery-3.jpg')}}" data-lightbox="gallery-3" class="my-auto"><i class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                        </div>
                        <div class="gallery-content">
                            <div class="gallery-inner pb-5">
                                <a href="#" class="h4 text-white">Beauty Of Life</a>
                ...
                <div class="col-lg-4">
                    <div class="gallery-item">
                        ...
                        <div class="search-icon">
                            <a href="{{asset('assets-guest/img/gallery-1.jpg')}}" data-lightbox="gallery-1" class="my-auto"><i class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                        </div>
                        <div class="gallery-content">
                            <div class="gallery-inner pb-5">
                                <a href="#" class="h4 text-white">Beauty Of Life</a>
                ...
                <div class="col-lg-4">
                    <div class="gallery-item">
                        ...
                        <div class="search-icon">
                            <a href="{{asset('assets-guest/img/gallery-4.jpg')}}" data-lightbox="gallery-4" class="my-auto"><i class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                        </div>
                        <div class="gallery-content">
                            <div class="gallery-inner pb-5">
                                <a href="#" class="h4 text-white">Beauty Of Life</a>
                    ...
                    <div class="gallery-item">
                        ...
                        <div class="search-icon">
                            <a href="{{asset('assets-guest/img/gallery-5.jpg')}}" data-lightbox="gallery-5" class="my-auto"><i class="fas fa-search-plus btn-hover-color bg-white text-primary p-3"></i></a>
                        </div>
                        <div class="gallery-content">
                            <div class="gallery-inner pb-5">
                                <a href="#" class="h4 text-white">Beauty Of Life</a>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('assets-guest/img/volunteers-1.jpg')}}" class="img-fluid w-100" alt="Image">
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('assets-guest/img/volunteers-3.jpg')}}" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('assets-guest/img/volunteers-2.jpg')}}" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('assets-guest/img/volunteers-4.jpg')}}" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
