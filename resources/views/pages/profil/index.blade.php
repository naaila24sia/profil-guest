...
<div class="container-fluid about py-5">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-xl-5">
                <div class="h-100">
                    <img src="{{ asset('assets-guest/img/profil.jpg') }}"
                         class="img-fluid w-80 h-100"
            ...
            <div class="col-xl-7">
                ...
                @if ($profil)
                    ...
                    <table class="table table-borderless fs-5 mb-4">
                        <tr><th width="200">Kecamatan</th><td>{{ $profil->kecamatan }}</td></tr>
                        <tr><th>Kabupaten</th><td>{{ $profil->kabupaten }}</td></tr>
                        <tr><th>Provinsi</th><td>{{ $profil->provinsi }}</td></tr>
                        <tr><th>Alamat Kantor</th><td>{{ $profil->alamat_kantor }}</td></tr>
                    ...
                    <div class="tab-class bg-secondary p-4">
                        ...
                        <ul class="nav d-flex mb-2">
                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 text-center bg-white active"
                                   data-bs-toggle="pill" href="#tab-about">
                                    <span class="text-dark" style="width: 150px;">Tentang Desa</span>
                                </a>
                            </li>

                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 mx-3 text-center bg-white"
                                   data-bs-toggle="pill" href="#tab-misi">
                                    <span class="text-dark" style="width: 150px;">Misi</span>
                                </a>
                            </li>

                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 text-center bg-white"
                                   data-bs-toggle="pill" href="#tab-visi">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <a href="{{ route('profil.create') }}" class="btn btn-primary mt-2">Tambah Profil</a>
                    </div>
                @endif
            </div>
